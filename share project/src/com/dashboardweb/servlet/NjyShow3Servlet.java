...
@WebServlet(urlPatterns = { "/show3" })
public class NjyShow3Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		NjyNameSearchService service2 = new NjyNameSearchService();
		NjyMemberVo memberInfo = service2.getInfo(playerId);
		...
		String path = "http://127.0.0.1:5000/njy/table-data?player=" + player;
